...
public class CUNKPSPublicSoap
{
    ...
    public CUNKPSPublicSoap(){}

    public CUNKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CUNKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CUNExtendedSoapSerializationEnvelope envelope= new CUNExtendedSoapSerializationEnvelope(CUNExtendedSoapSerializationEnvelope.VER11);
