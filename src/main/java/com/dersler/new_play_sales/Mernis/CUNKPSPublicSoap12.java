...
public class CUNKPSPublicSoap12
{
    interface CUNIWcfMethod
    {
        CUNExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(CUNExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public CUNKPSPublicSoap12(){}

    public CUNKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public CUNKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected CUNExtendedSoapSerializationEnvelope createEnvelope()
    {
        CUNExtendedSoapSerializationEnvelope envelope= new CUNExtendedSoapSerializationEnvelope(CUNExtendedSoapSerializationEnvelope.VER12);
    ...
    protected java.util.List sendRequest(String methodName,CUNExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,CUNExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new CUNIWcfMethod()
        {
            @Override
            public CUNExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                CUNExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(CUNExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(CUNIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        CUNExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,CUNExtendedSoapSerializationEnvelope envelope)
    {
