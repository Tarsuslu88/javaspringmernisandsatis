...
class CUNSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class CUNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CUNDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new CUNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CUNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CUNDateTimeConverter dateTimeConverter = new CUNStandardDateTimeConverter();

    public CUNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CUNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CUNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CUNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CUNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CUNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
